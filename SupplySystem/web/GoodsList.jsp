...
<head>
  ...
  <title>Система контроля закупок - Товар</title>
...
<script src="../../js/bootstrap.min.js"></script>
 ...
 <script type="text/javascript">
     ...
     $(document).ready(function(){
         ...
         $("#add").click(function(){
             location.href="/app/editGoods";
         });

         $("#edit").click(function(){
             selectedID = +$("[checked] .id").text();
             if (selectedID != 0) {
                 location.href="/app/editGoods?id="+selectedID;
             }
         });
         ...
         $("#delete").click(function(){
             selectedID = +$("[checked] .id").text();
             if (selectedID != 0) {
                 location.href="/app/deleteGoods?id="+selectedID;
             }
         });
