...
<head>
  ...
  <title>Система контроля закупок - Отчет</title>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="/app/report">Отчёт</a></li>
          </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Заказанные товары</h1>
          ...
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tbody>
              <c:forEach var="line" items="${report}" varStatus="loopCounter">
                  <tr>
